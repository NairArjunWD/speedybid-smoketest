        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="grid grid-cols-2 gap-8 xl:col-span-2">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm font-normal text-gray-400 tracking-wider uppercase">Solutions</h3>
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-sm font-normal text-gray-400 tracking-wider uppercase">Support</h3>
                  <ul className="mt-4 space-y-4">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm font-normal text-gray-400 tracking-wider uppercase">Company</h3>
                  <ul className="mt-4 space-y-4">
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-sm font-normal text-gray-400 tracking-wider uppercase">Legal</h3>
                  <ul className="mt-4 space-y-4">
            ...
            <div className="mt-8 xl:mt-0">
              <h3 className="text-sm font-normal text-gray-400 tracking-wider uppercase">
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-sm text-gray-400 md:mt-0 md:order-1">
              &copy; 2020 Storgogo, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
